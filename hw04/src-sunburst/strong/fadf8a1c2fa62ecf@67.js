...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>調查涵蓋了多種工作地點類型，包括工作室、金融機構、政府機關等。這顯示藝術行業從業者的工作環境多樣化，涉及不同的行業和機構。</li>
    <li>在受訪者中，工作室似乎是較常見的工作地點。這反映了藝術家和創意工作者可能更傾向於在私人或專業的工作室環境中工作。</li>
    <li>許多受訪者表示他們採取了減少碳排放的行動。這包括使用無毒媒材、再生材料、廢物利用素材等，顯示出對環境保護的高度關注。</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#86473F","#EB7A77","#554236","#C73E3A","#954A45","#904840"])
  .unknown("#BEBEBE")
)}
